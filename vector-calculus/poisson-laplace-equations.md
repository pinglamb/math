...
> *Proposition.*{: .prop}
> In $\mathbb{R}^3$, the spherically symmetric solution to Laplace's equation is of the form
>
> $$
...
> $$
  ...
  $$
>
> is referred to as the potential of the _unit point source_, or as the **unit monopole**, or as the _fundamental solution_ of Poisson's equation in $\mathbb{R}^3$.
...
In $\mathbb{R}^3$, the singularity will extend to the whole $z$-axis ($r = 0$) in cylindrical polars.
