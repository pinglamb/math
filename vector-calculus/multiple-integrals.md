...
>
> $$
  \int_R dx\,dy \,f(x, y) = \int_{R'} du\,dv \, \left|{ \partial (x, y) \over \partial (u, v) }\right| \,g(u, v)
  $$
>
> *Proof.*{: .prf}
>
...
>
> Since $v$ is constant along the line $KL$, $KL$ has components $(\partial x / \partial u)\,du$ and $(\partial y / \partial u)\,du$.
> Similarily, since $u$ is constant along the line $KN$, $KN$ has components $(\partial x / \partial v)\,dv$ and $(\partial y / \partial v)\,dv$.
> Thus, the area of the subregion is given by
>
> $$
  \begin{align*}
  dA_{uv} &= \left| {\partial x \over \partial u} du {\partial y \over \partial v} dv - {\partial x \over \partial v} dv {\partial y \over \partial u} du \right| \\
  ...
  $$
>
> Therefore, the relationship between the size of area generated by $dx$ and $dy$ and that by $du$ and $dv$ is
>
> $$
  dx\,dy = \left| { \partial (x, y) \over \partial (u, v) } \right| \,du\,dv
  $$
